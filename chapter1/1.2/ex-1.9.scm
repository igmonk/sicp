...
;; 9
;;
;; The process is characterized by a chain of deferred operations (inc),
;; thereby, it is a recursive process.
...
;; 9
;;
;; The state of the process can be summarized by a fixed number of state variables (a and b),
;; thereby, it is an iterative process.
