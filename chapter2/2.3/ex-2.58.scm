...
;; so that it works with ordinary mathematical notation,
...
;; we can modify it to work with different representations of expressions
;; solely by changing the predicates, selectors, and constructors
;; that define the representation of the algebraic expressions
...
;;    Can you design appropriate predicates, selectors, and constructors
