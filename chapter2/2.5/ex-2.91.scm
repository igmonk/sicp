;; Exercise 2.91
;;
;; A univariate polynomial can be divided by another one
;; to produce a polynomial quotient and a polynomial remainder.
;;
;; For example,
;;
...
;; the highest-order term of the divisor.
...
;; Also, if the dividend ever becomes zero, return zero
;; as both quotient and remainder.
;;
...
;; If so, div-poly strips off the variable and passes the problem to div-terms,
...
;; It is convenient to design div-terms to compute both
;; the quotient and the remainder of a division.
;; Div-terms can take two term lists as arguments and return a list of
...
;; Use this to implement div-poly, which takes two polys as arguments
...
;; (div p1 p2) ; ((polynomial x (3 1) (1 1)) (polynomial x (1 1) (0 -1)))
;;             ; = x^3 + x, remainder x - 1
