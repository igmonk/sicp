...
;;  And when I delete both items, the second b is still there, so the queue isn't empty,
...
;;  you'll have to define your own print procedure for queues."
;;
;; Explain what Eva Lu is talking about.
;; In particular, show why Ben's examples produce the printed results that they do.
;;
;; Define a procedure print-queue that takes a queue as input and prints the sequence
;; of items in the queue.


;; The queue is represented by a pair, whose car refers to the items of the queue
;; (represented as a list)  and cdr refers to the final one.
;; Therefore, the standard Lisp printer prints both the internal list of items and
;; the last pair that represents the final item of the queue.
