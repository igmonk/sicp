...
;; itself takes one input.
;;
;; The result returned by 'make-monitored' is a third procedure, say mf, that
...
;;
;; If the input is the special symbol 'reset-count',
;; then mf resets the counter to zero.
;;
