;; Exercise 4.54
;;
;; If we had not realized that 'require' could be implemented as
;; an ordinary procedure that uses amb, to be defined by the user
;; as part of a nondeterministic program, we would have had to
